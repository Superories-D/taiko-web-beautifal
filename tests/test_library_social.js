...
assert.match(playerLab, /difficulty-favorite-trigger/)
assert.match(playerLab, /updateDifficultyFavorite/)
assert.match(libraryView, /library-filter-toggle/)
assert.match(songView, /library-filter-toggle/)
assert.match(library, /syncFavorites/)
assert.match(social, /statusLabel/)
assert.match(social, /friendlyError/)
